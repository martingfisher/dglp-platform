			...
			<dl class="dgl-review__list">
				...
				<dd>
					<?php if ( '' !== (string) $data['website'] ) : ?>
						<a href="<?php echo esc_url( (string) $data['website'] ); ?>" rel="noopener" target="_blank"><?php echo esc_html( (string) $data['website'] ); ?></a>
					<?php else : ?>
						<?php esc_html_e( 'None recorded', 'dgl-platform' ); ?>
					<?php endif; ?>
				</dd>
				<dt><?php esc_html_e( 'Email', 'dgl-platform' ); ?></dt>
				<dd><?php echo '' !== (string) $data['email'] ? esc_html( (string) $data['email'] ) : esc_html__( 'None recorded', 'dgl-platform' ); ?></dd>
				<dt><?php esc_html_e( 'Phone', 'dgl-platform' ); ?></dt>
				<dd><?php echo '' !== (string) $data['phone'] ? esc_html( (string) $data['phone'] ) : esc_html__( 'None recorded', 'dgl-platform' ); ?></dd>
