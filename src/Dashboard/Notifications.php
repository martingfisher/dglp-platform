...
final class Notifications {
	...
	public static function readable(): array {
		return [
			...
			'cancelled'                   => [ 'title' => __( 'Marked cancelled', 'dgl-platform' ), 'tone' => 'attention' ],
			'reinstated'                  => [ 'title' => __( 'Back on: no longer cancelled', 'dgl-platform' ), 'tone' => 'good' ],
			'date_cancelled'              => [ 'title' => __( 'One date cancelled', 'dgl-platform' ), 'tone' => 'attention' ],
			'date_reinstated'             => [ 'title' => __( 'A cancelled date is back on', 'dgl-platform' ), 'tone' => 'good' ],
